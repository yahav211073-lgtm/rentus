...
export default async function ReviewPolicyPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6">
      <h1 className="mb-6 font-display text-3xl font-extrabold text-ink-900">מדיניות ביקורות</h1>
      <div className="space-y-5 text-base leading-relaxed text-ink-600">
        ...
        <div>
          <h2 className="mb-2 font-bold text-ink-900">איך זה עובד</h2>
        ...
        <div>
          <h2 className="mb-2 font-bold text-ink-900">דיווח על ביקורת</h2>
