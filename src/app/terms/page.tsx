...
export default async function TermsPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6">
      <h1 className="mb-6 font-display text-3xl font-extrabold text-ink-900">תנאי שימוש</h1>
      <div className="space-y-5 text-base leading-relaxed text-ink-600">
        ...
        <div>
          <h2 className="mb-2 font-bold text-ink-900">אחריות</h2>
          <p>
        ...
        <div>
          <h2 className="mb-2 font-bold text-ink-900">תוכן ורישום עסקים</h2>
          <p>
        ...
        <div>
          <h2 className="mb-2 font-bold text-ink-900">קניין רוחני</h2>
          <p>עיצוב האתר, הלוגו והתוכן המערכתי שייכים ל-{brand.name}. תוכן שהעלה בעל עסק (תמונות, טקסטים) נשאר בבעלותו.</p>
        </div>
        <div>
          <h2 className="mb-2 font-bold text-ink-900">שינויים בתנאים</h2>
