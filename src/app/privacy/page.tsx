...
export default async function PrivacyPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6">
      <h1 className="mb-6 font-display text-3xl font-extrabold text-ink-900">מדיניות פרטיות</h1>
      <div className="space-y-5 text-base leading-relaxed text-ink-600">
        ...
        <div>
          <h2 className="mb-2 font-bold text-ink-900">מה נשמר</h2>
        ...
        <div>
          <h2 className="mb-2 font-bold text-ink-900">שיתוף מידע</h2>
          <p>פרטי פנייה שאתם שולחים לעסק מועברים לאותו עסק בלבד, לצורך יצירת קשר. איננו מוכרים מידע אישי לצד שלישי.</p>
        </div>
        <div>
          <h2 className="mb-2 font-bold text-ink-900">זכויותיכם</h2>
          <p>
