  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6">
      ...
      <a
        ...
        className="mb-8 flex items-center justify-between gap-4 rounded-lg border border-success-500/30 bg-success-50 p-5 transition-colors hover:border-success-500/50"
      >
      ...
      {user ? (
        ...
        <div className="rounded-lg border border-ink-200/70 bg-white p-7 text-center">
